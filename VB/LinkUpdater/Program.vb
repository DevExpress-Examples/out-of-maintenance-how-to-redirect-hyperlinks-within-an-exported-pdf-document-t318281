...
Namespace LinkUpdater
    Friend Class Program
        Shared Sub Main(ByVal args() As String)
            ...
            server.AddService(GetType(IPdfLinkUpdater), linkUpdater)
    ...
    Friend Class LinkUpdater
        Implements IPdfLinkUpdater

        Private ReadOnly map As New Dictionary(Of String, String)()
        Private newAnchor As String

        Public Sub RedirectUri(ByVal uri As String, ByVal anchor As String)
            map(uri) = anchor
        End Sub

        Public Function UpdateLinkToPage(ByVal uri As String, ByVal anchor As String) As String Implements IPdfLinkUpdater.UpdateLinkToPage
            ...
            Return anchor
        End Function
        Public Function UpdateLinkToUri(ByVal uri As String) As String Implements IPdfLinkUpdater.UpdateLinkToUri
